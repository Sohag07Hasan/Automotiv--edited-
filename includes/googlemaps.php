        ...
        <script type="text/javascript">
          function LoadMapSearchControl() {
            ...
            new GSmapSearchControl(
                  ...
                  "<?php if (get_post_meta($post->ID, "google_location_value", $single = true)) { 
				  echo get_post_meta($post->ID, "google_location_value", $single = true);
				  } else { 
				  echo $address . " " . get_post_meta($post->ID, "citystatezip_value", $single = true); 
				  } ?>",
                  options
                  );
